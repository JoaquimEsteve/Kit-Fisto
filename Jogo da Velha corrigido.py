...
class Game:
    ...
    def check_draw(self):
        for row in self.board:
            if " " in row:     # Por algum motivo estava escrito "not" aqui, fazendo com que o jogo sempre finalizasse em empate, independente de onde fosse colocado algo. Tirando o "not" do código, é possível que ele corretamente identifique um caso de empate.
                return False
        return True
